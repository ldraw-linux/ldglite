...
<plist version="0.9">
  <dict>
    ...
    <key>CFBundleVersion</key>			<string>1.0.7</string>
    <key>CFBundleShortVersionString</key>	<string>ldglite 1.0.7</string>
    <key>CFBundleGetInfoString</key>		<string>ldglite 1.0.7 http://ldglite.sourceforge.net</string>
